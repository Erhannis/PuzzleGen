...
public class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Collection<Cell> cells = Phase1CellGeneration.generateHexBoard(50, 20, true);
    ...
    for (int i = 0; i < 1; i++) {
      System.err.print(i + " ");
      Set<Group> lGroups = Phase2Grouping.groupCellsDefault(cells.stream().findAny().get(), 25, 0);
      System.err.println("");
